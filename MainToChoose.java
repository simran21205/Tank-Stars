...
public class MainToChoose implements Screen {
    ...
    public MainToChoose(final TankStars app) {
        this.app = app;
...
//        backgroungTexture = new TextureRegion(new Texture("tankstars.jpg"),0,0,2048,563);
    ...
    private void queueAssets() {
        app.assets.load("Choose1.jpeg", Texture.class);
...
//        shapeRenderer.setProjectionMatrix(app.camera.combined);
    ...
    public void render(float delta) {
        ...
        app.batch.begin();
        app.font.draw(app.batch, "Sreen : Loading", 20, 20);
        app.batch.end();
    }
