...
public class GameScreen9 implements Screen, InputProcessor {
    ...
    public GameScreen9(final TankStars app) {
        this.app = app;
...
//        backgroundMaxScrollingSpeed = (float) (WORLD_HEIGHT) / 4;
        ...
        enemyShip = new EnemyTank(WORLD_HEIGHT*2/4,WORLD_WIDTH/2,
                ...
                10, 10,
                2f,1f,40,2f,
                tank1TextureRegion, tank1TextureRegion,enemyWeaponTextureRegion);
