...
//        backgroungTexture = new TextureRegion(new Texture("tankstars.jpg"),0,0,2048,563);
    ...
    private void queueAssets() {
        ...
        app.assets.load("settings.png", Texture.class);
        app.assets.load("weapons.png", Texture.class);
...
//        shapeRenderer.rect(75, app.camera.viewportHeight / 2 , app.camera.viewportWidth -150, 16);
//
//        shapeRenderer.setColor(Color.BLUE);
//        shapeRenderer.rect(75, app.camera.viewportHeight / 2 , progress * (app.camera.viewportWidth -150), 16);
//        shapeRenderer.end();

        app.batch.begin();
        app.font.draw(app.batch, "AP COURSE PROJECT - TANK STARS GAME", 250, 250);
        app.font.draw(app.batch, "NIKITA VERMA AND SIMRAN CHOUDHARY", 260, 230);
