...
public class ChooseTank2 implements Screen {
    ...
    private TextButton buttonNew, buttonExit, buttonResume, buttonBack, head ;

    private ShapeRenderer shapeRenderer;
    private Image splashImg;

    public ChooseTank2(final TankStars app) {
        this.app = app;
    ...
    public void show() {
        ...
        Texture splashTex = app.assets.get("Choose1.jpeg", Texture.class);
        splashImg = new Image(splashTex);
        splashImg.setOrigin(splashImg.getWidth() / 2, splashImg.getHeight() / 2);
        splashImg.setPosition(stage.getWidth() / 2 - 500, stage.getHeight()/2 - 310);
        splashImg.addAction(sequence(alpha(0), scaleTo(0.6f, 0.6f), parallel(fadeIn(0f),
                scaleTo(0.6f, 0.6f, 2f),
                moveTo(stage.getWidth() / 2 - 500, stage.getHeight() / 2 - 310, 2f))));
    ...
    private void initButtons() {
        head = new TextButton("Player 2 choose tank ", skin);
        head.setPosition(135, 240);
        head.setSize(200, 30);
...
//            });
        ...
        buttonNew.setPosition(160, 200);
        buttonNew.setSize(150, 30);
        ...
        buttonResume.setPosition(160, 160);
        buttonResume.setSize(150, 30);
        ...
        buttonExit.setPosition(160, 120);
